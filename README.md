...
> 系统架构总览。点击查看[交互式版本](docs/architecture/system-diagram.html)（自包含 HTML，下载后浏览器打开：明暗主题切换 + 导出 PNG/SVG）；图形源见 [system-diagram.architecture.json](docs/architecture/system-diagram.architecture.json)。
