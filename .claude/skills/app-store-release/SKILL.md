...
iPhone 截图每组 1–10 张竖屏。**ASC 的截图槽位不自动缩放,尺寸必须精确匹配**——别指望「传 6.9"
一组就够、ASC 自动缩放」(实测会报 dimensions wrong 被拒)。App 记录的 iPhone 槽位接受:

- **6.5"/6.7" 槽位**:`1242×2688`(6.5")或 `1284×2778`(6.7");
- **6.9" 槽位**:`1320×2868`。

本机模拟器目前多是 **6.9"**(iPhone 17 Pro Max = `1320×2868`);若上传的槽位要 6.5"/6.7",
把 6.9" 原图转过去:`sips --resampleWidth 1284 x.png && sips -c 2778 1284 x.png`(等比缩到宽 1284
再居中裁到 2778 = `1284×2778`,无拉伸)。据 ASC 报的可接受尺寸挑目标值。
